  ...
  <section id="sec_02" class="sec">
    <h2 class="ttl_en-ja align_center">
      ...
      <div class="desc align_center">
        <p>
          ぱどの事業を推進してくうえで、会社が社員の皆さんと共有したい基本姿勢を「ぱどバリュー」<br>
          として定めます(内容は適宜見直し、今会社が皆さんと一番共有したいものを設定します)。<br>
          皆さんがこの「ぱどバリュー」を常に意識し、ぱど社員としての価値観を体現しながら<br>
          日々の業務に取り組むことで、会社と社員が同じ方向を向いて成長していくことができます。
        </p>

      </div>
        <div class="vision">
          <p>人・街・元気</p>
          <p>情報を通じて 人と人 人と街をつなぎ 人も街も元気にする</p>
        </div>
        <p>「顧客志向」を重視しつつ、 ぱどバリュー(基本姿勢)を大事にして実施</p>
    ...
    <div class="cont col_2 col_2-right">
      <div>
        ...
        <ul >
          ...
          <li><figure><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/value/img_value_03.png" alt="チャレンジ"><figcaption>常に変化を恐れずに挑戦を続け、事業拡大のエンジンとなる</figcaption></figure></li>
        </ul>
      </div>
    </div>
  </section>
