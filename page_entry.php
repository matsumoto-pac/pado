...
<dd>
<span class="wpcf7-form-control-wrap birth-y"><input type="text" name="birth-y" value="" size="8" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required s8" id="birth_y" aria-required="true" aria-invalid="false" /></span>年<span class="wpcf7-form-control-wrap birth-m"><select type="text" name="birth-m" value="" size="1" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required s1" id="birth_y" aria-required="true" aria-invalid="false" /><option value=""></option><option value="1月">1</option><option value="2月">2</option><option value="3月">3</option><option value="4月">4</option><option value="5月">5</option><option value="6月">6</option><option value="7月">7</option><option value="8月">8</option><option value="9月">9</option><option value="10月">10</option><option value="11月">11</option><option value="12月">12</option></select></span>月<span class="wpcf7-form-control-wrap birth-d"><select type="text" name="birth-d" value="" size="1" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required s1" id="birth_y" aria-required="true" aria-invalid="false" /><option value=""></option><option value="1日">1</option><option value="2日">2</option><option value="3日">3</option><option value="4日">4</option><option value="5日">5</option><option value="6日">6</option><option value="7日">7</option><option value="8日">8</option><option value="9日">9</option><option value="10日">10</option><option value="11日">11</option><option value="12日">12</option><option value="13日">13</option><option value="14日">14</option><option value="15日">15</option><option value="16日">16</option><option value="17日">17</option><option value="18日">18</option><option value="19日">19</option><option value="20日">20</option><option value="21日">21</option><option value="22日">22</option><option value="23日">23</option><option value="24日">24</option><option value="25日">25</option><option value="26日">26</option><option value="27日">27</option><option value="28日">28</option><option value="29日">29</option><option value="30日">30</option><option value="31日">31</option></select></span>日<br />
...
<dd>
<span class="wpcf7-form-control-wrap education"><select name="education" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required s7" id="education" aria-required="true" aria-invalid="false"><option value=""></option><option value="大学院">大学院</option><option value="大学">大学</option><option value="短大">短大</option><option value="高専">高専</option><option value="専門／専修">専門／専修</option><option value="高校">高校</option><option value="中学">中学</option><option value="その他">その他</option></select></span><br />
<span class="wpcf7-form-control-wrap ed_year"><input type="text" name="ed_year" value="" size="8" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required s8" id="ed_year" aria-required="true" aria-invalid="false" /></span>年<span class="wpcf7-form-control-wrap ed_month"><select type="text" name="ed_month" value="" size="1" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required s1" id="ed_month" aria-required="true" aria-invalid="false" /><option value=""></option><option value="1月">1</option><option value="2月">2</option><option value="3月">3</option><option value="4月">4</option><option value="5月">5</option><option value="6月">6</option><option value="7月">7</option><option value="8月">8</option><option value="9月">9</option><option value="10月">10</option><option value="11月">11</option><option value="12月">12</option></select></span>月<span class="wpcf7-form-control-wrap ed_status"><select name="ed_status" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required s7" id="ed_status" aria-required="true" aria-invalid="false"><option value=""></option><option value="卒業見込み">卒業見込み</option><option value="卒業">卒業</option><option value="中退">中退</option></select></span><br />
<span class="note">必須入力項目です。</span></dd>
</dl>
<dl class="form-item">
